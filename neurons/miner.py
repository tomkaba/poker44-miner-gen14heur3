"""Poker44 miner for standalone gen14heur3 heuristic release."""
...
class Miner(BaseMinerNeuron):
    """Deterministic chunk scorer for gen14heur3 profile."""

    def __init__(self, config=None):
        super(Miner, self).__init__(config=config)
        bt.logging.info("Heuristic Poker44 Miner started (gen14heur3)")
        self.prediction_threshold = 0.5
        self._task_response_cache = {}

        chunk_scorer = "gen14heur3"
        bt.logging.info("[init] POKER44_CHUNK_SCORER=gen14heur3 (hardcoded)")
        ...
        self.model_manifest = build_local_model_manifest(
            ...
            defaults={
                ...
                "license": "MIT",
                "repo_url": "https://github.com/tomkaba/poker44-miner-gen14heur3",
    ...
    async def forward(self, synapse: DetectionSynapse) -> DetectionSynapse:
        ...
        bt.logging.info(f"Scored {len(chunks)} chunks with gen14heur3 heuristic.")
        return synapse
